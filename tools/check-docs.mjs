...
const required = ['AGENTS.md', 'ARCHITECTURE.md', 'docs/README.md', 'docs/design-docs/index.md', 'docs/design-docs/core-beliefs.md', 'docs/design-docs/system-architecture.md', 'docs/design-docs/functional-design.md', 'docs/product-specs/index.md', 'docs/product-specs/dockyard-mvp.md', 'docs/exec-plans/active/2026-08-bootstrap.md', 'docs/tech-debt-tracker.md'];
